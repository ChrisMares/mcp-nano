...
namespace System.Text.Json
{
    ...
    public record MaxDiscountLogItemSummary
    {
        public string ItemNumber { get; init; }
        public string PcatName { get; init; }
        public int TotalQuantity { get; init; }
        public decimal TotalDollarDiscount { get; init; }
        public decimal AvgDiscountPct { get; init; }
    }

    public record MaxDicount2(string ItemNumber, string PcatName, int TotalQuantity, decimal TotalDollarDiscount, decimal AvgDiscountPct);
    ...
    public delegate void JsonWriteCallback(ref Utf8JsonWriter writer, string value, JavaScriptEncoder? encoder);
